...
trait CustomerOpsExp extends CustomerOps with FieldAccessOpsExp with EffectExp with BaseFatExp {
  ...
  def customer_c_custkey(__x: Rep[Customer]) = AppFieldRead[Int](__x, "c_custkey", "Int")
  def customer_c_name(__x: Rep[Customer]) = AppFieldRead[String](__x, "c_name", "String")
  def customer_c_address(__x: Rep[Customer]) = AppFieldRead[String](__x, "c_address", "String")
  def customer_c_nationkey(__x: Rep[Customer]) = AppFieldRead[Int](__x, "c_nationkey", "Int")
  def customer_c_phone(__x: Rep[Customer]) = AppFieldRead[String](__x, "c_phone", "String")
  def customer_c_acctbal(__x: Rep[Customer]) = AppFieldRead[Double](__x, "c_acctbal", "Double")
  def customer_c_mktsegment(__x: Rep[Customer]) = AppFieldRead[String](__x, "c_mktsegment", "String")
  def customer_c_comment(__x: Rep[Customer]) = AppFieldRead[String](__x, "c_comment", "String")
...
trait LineItemOpsExp extends LineItemOps with FieldAccessOpsExp with EffectExp with BaseFatExp {
  ...
  def lineitem_l_orderkey(__x: Rep[LineItem]) = AppFieldRead[Int](__x, "l_orderkey", "Int")
  def lineitem_l_partkey(__x: Rep[LineItem]) = AppFieldRead[Int](__x, "l_partkey", "Int")
  def lineitem_l_suppkey(__x: Rep[LineItem]) = AppFieldRead[Int](__x, "l_suppkey", "Int")
  def lineitem_l_linenumber(__x: Rep[LineItem]) = AppFieldRead[Int](__x, "l_linenumber", "Int")
  def lineitem_l_quantity(__x: Rep[LineItem]) = AppFieldRead[Double](__x, "l_quantity", "Double")
  def lineitem_l_extendedprice(__x: Rep[LineItem]) = AppFieldRead[Double](__x, "l_extendedprice", "Double")
  def lineitem_l_discount(__x: Rep[LineItem]) = AppFieldRead[Double](__x, "l_discount", "Double")
  def lineitem_l_tax(__x: Rep[LineItem]) = AppFieldRead[Double](__x, "l_tax", "Double")
  def lineitem_l_returnflag(__x: Rep[LineItem]) = AppFieldRead[Char](__x, "l_returnflag", "Char")
  def lineitem_l_linestatus(__x: Rep[LineItem]) = AppFieldRead[Char](__x, "l_linestatus", "Char")
  def lineitem_l_shipdate(__x: Rep[LineItem]) = AppFieldRead[Date](__x, "l_shipdate", "Date")
  def lineitem_l_commitdate(__x: Rep[LineItem]) = AppFieldRead[Date](__x, "l_commitdate", "Date")
  def lineitem_l_receiptdate(__x: Rep[LineItem]) = AppFieldRead[Date](__x, "l_receiptdate", "Date")
  def lineitem_l_shipinstruct(__x: Rep[LineItem]) = AppFieldRead[String](__x, "l_shipinstruct", "String")
  def lineitem_l_shipmode(__x: Rep[LineItem]) = AppFieldRead[String](__x, "l_shipmode", "String")
  def lineitem_l_comment(__x: Rep[LineItem]) = AppFieldRead[String](__x, "l_comment", "String")
...
trait NationOpsExp extends NationOps with FieldAccessOpsExp with EffectExp with BaseFatExp {
  ...
  def nation_n_nationkey(__x: Rep[Nation]) = AppFieldRead[Int](__x, "n_nationkey", "Int")
  def nation_n_name(__x: Rep[Nation]) = AppFieldRead[String](__x, "n_name", "String")
  def nation_n_regionkey(__x: Rep[Nation]) = AppFieldRead[Int](__x, "n_regionkey", "Int")
  def nation_n_comment(__x: Rep[Nation]) = AppFieldRead[String](__x, "n_comment", "String")
...
trait OrderOpsExp extends OrderOps with FieldAccessOpsExp with EffectExp with BaseFatExp {
  ...
  def order_o_orderkey(__x: Rep[Order]) = AppFieldRead[Int](__x, "o_orderkey", "Int")
  def order_o_custkey(__x: Rep[Order]) = AppFieldRead[Int](__x, "o_custkey", "Int")
  def order_o_orderstatus(__x: Rep[Order]) = AppFieldRead[Char](__x, "o_orderstatus", "Char")
  def order_o_totalprice(__x: Rep[Order]) = AppFieldRead[Double](__x, "o_totalprice", "Double")
  def order_o_orderdate(__x: Rep[Order]) = AppFieldRead[Date](__x, "o_orderdate", "Date")
  def order_o_orderpriority(__x: Rep[Order]) = AppFieldRead[String](__x, "o_orderpriority", "String")
  def order_o_clerk(__x: Rep[Order]) = AppFieldRead[String](__x, "o_clerk", "String")
  def order_o_shippriority(__x: Rep[Order]) = AppFieldRead[Int](__x, "o_shippriority", "Int")
  def order_o_comment(__x: Rep[Order]) = AppFieldRead[String](__x, "o_comment", "String")
...
trait PartOpsExp extends PartOps with FieldAccessOpsExp with EffectExp with BaseFatExp {
  ...
  def part_p_partkey(__x: Rep[Part]) = AppFieldRead[Int](__x, "p_partkey", "Int")
  def part_p_name(__x: Rep[Part]) = AppFieldRead[String](__x, "p_name", "String")
  def part_p_mfgr(__x: Rep[Part]) = AppFieldRead[String](__x, "p_mfgr", "String")
  def part_p_brand(__x: Rep[Part]) = AppFieldRead[String](__x, "p_brand", "String")
  def part_p_type(__x: Rep[Part]) = AppFieldRead[String](__x, "p_type", "String")
  def part_p_size(__x: Rep[Part]) = AppFieldRead[Int](__x, "p_size", "Int")
  def part_p_container(__x: Rep[Part]) = AppFieldRead[String](__x, "p_container", "String")
  def part_p_retailprice(__x: Rep[Part]) = AppFieldRead[Double](__x, "p_retailprice", "Double")
  def part_p_comment(__x: Rep[Part]) = AppFieldRead[String](__x, "p_comment", "String")
...
trait PartSupplierOpsExp extends PartSupplierOps with FieldAccessOpsExp with EffectExp with BaseFatExp {
  ...
  def partsupplier_ps_partkey(__x: Rep[PartSupplier]) = AppFieldRead[Int](__x, "ps_partkey", "Int")
  def partsupplier_ps_suppkey(__x: Rep[PartSupplier]) = AppFieldRead[Int](__x, "ps_suppkey", "Int")
  def partsupplier_ps_availqty(__x: Rep[PartSupplier]) = AppFieldRead[Int](__x, "ps_availqty", "Int")
  def partsupplier_ps_supplycost(__x: Rep[PartSupplier]) = AppFieldRead[Double](__x, "ps_supplycost", "Double")
  def partsupplier_ps_comment(__x: Rep[PartSupplier]) = AppFieldRead[String](__x, "ps_comment", "String")
...
trait RegionOpsExp extends RegionOps with FieldAccessOpsExp with EffectExp with BaseFatExp {
  ...
  def region_r_regionkey(__x: Rep[Region]) = AppFieldRead[Int](__x, "r_regionkey", "Int")
  def region_r_name(__x: Rep[Region]) = AppFieldRead[String](__x, "r_name", "String")
  def region_r_comment(__x: Rep[Region]) = AppFieldRead[String](__x, "r_comment", "String")
...
trait SupplierOpsExp extends SupplierOps with FieldAccessOpsExp with EffectExp with BaseFatExp {
  ...
  def supplier_s_suppkey(__x: Rep[Supplier]) = AppFieldRead[Int](__x, "s_suppkey", "Int")
  def supplier_s_name(__x: Rep[Supplier]) = AppFieldRead[String](__x, "s_name", "String")
  def supplier_s_address(__x: Rep[Supplier]) = AppFieldRead[String](__x, "s_address", "String")
  def supplier_s_nationkey(__x: Rep[Supplier]) = AppFieldRead[Int](__x, "s_nationkey", "Int")
  def supplier_s_phone(__x: Rep[Supplier]) = AppFieldRead[String](__x, "s_phone", "String")
  def supplier_s_acctbal(__x: Rep[Supplier]) = AppFieldRead[Double](__x, "s_acctbal", "Double")
  def supplier_s_comment(__x: Rep[Supplier]) = AppFieldRead[String](__x, "s_comment", "String")
